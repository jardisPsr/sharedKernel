...
interface DataServiceInterface
{
     ...
     * @param array<string, mixed> $data Database row data (column_name => value)
     * @return void
     */
     ...
     * @param array<string, mixed> $data Nested array data (from toArray())
     * @return void
     */
    public function hydrateFromArray(object $aggregate, array $data): void;
